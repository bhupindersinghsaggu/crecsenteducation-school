...
<head>
    <meta charset="UTF-8">
    <title>Crescent Public School-BEST CBSE School</title>
                    ...
                    <div class="outer-box">
                        <div class="header-top-left">
                            ...
                            <div class="info-box">
                                ...
                                <p class="clearfix"> <a href="http://Curtina.in/_mobile/login.aspx?AppId=CRESCENT"
                                        target="_blank" style="color:#fff;">ERP Login
                                    </a></p>
                            </div>
                        </div>
                        ...
                        <div class="header-top-right">
                            <div class="quick-link-box">
                                <div class="link-box">
                                    <ul>
                                        <li><a href="applyforhostel.php"
                                                target="_blank">Apply For Hostel</a></li>
                                        <li><a href="https://curtina.in/_ERP/forms/frmJobApplicationCR_AE_JQ.aspx?appid=CRESCENT"
                                                target="_blank">Apply For Job</a></li>
                                        <li><a href="http://Curtina.in/crescent?url=http://Curtina.in/_Web/frmFindTC.aspx"
...
-->
                    ...
                    <div class="outer-box">
                        ...
                        <div class="header-middle">
                            <div class="main-logo-box">
                                <a href="index.php">
                                    <img src="assets/images/logo.png" alt="Awesome Logo" title="" class="my-logo">
                                </a>
                            </div>
            ...
            <div class="mobile-menu">
                ...
                <nav class="menu-box">
                    <div class="nav-logo">
                        <a href="index.php">
                            <img src="assets/images/logo.png" alt="" title="" style="    background: #a4d39a;
    padding: 10px;
    border-radius: 10px;">
                        </a>
                    </div>
                    ...
                    <div class="social-links">
                        <ul class="clearfix">
                            <li><a href="https://www.facebook.com/crescentpublicschoolpalampur"><span
